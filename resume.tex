...
\begin{document}
	...
	\resumeItem{Census Analytics}{
		\begin{description}[font=$\diamond$\scshape\bfseries,leftmargin=11pt,labelindent=0pt]
			\item Working in Census analytics team building both front end and backend system for user data streaming, ETL, presentation and analysis.
		\end{description}}
	\resumeItemListEnd
