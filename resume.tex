...
\begin{document}
	...
	{Agile team player including pair-coding, code review, test and validation 　in full lifecycle, etc.}
	\resumeSubHeadingListEnd
	...
	\resumeItem{Demand Side Platform}
		...
		\begin{description}[font=$\diamond$\scshape\bfseries,leftmargin=11pt,labelindent=0pt]
					...
					\item Major contributor in Open RTB integration and built Native ads serving from scratch with DB design, request/serving mechanism and internal preview API.
