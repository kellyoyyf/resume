...
\begin{center}
\large\bf Li Pei \\ % Your name
%\vspace{20pt} \hrule height 1pt % If you would like a horizontal line separating the name from the address, uncomment the line to the left of this text
615 Pavonia Ave APT 1403 \\ Jersey City, NJ 07306 \\ (412) 419-4227, lipei.work@gmail.com % Your address and phone number
\end{center} 
\vfill

\signature{Li Pei} % Your name for the signature at the bottom
